...
export interface ApiDailyUiDailyUi extends Struct.CollectionTypeSchema {
  collectionName: 'daily_uis';
  info: {
    description: '';
    displayName: 'DailyUI';
    pluralName: 'daily-uis';
    singularName: 'daily-ui';
  };
  options: {
...
export interface ApiDsLibraryDsLibrary extends Struct.CollectionTypeSchema {
  collectionName: 'ds_libraries';
  info: {
    description: '';
    displayName: 'DSLibrary';
    pluralName: 'ds-libraries';
    singularName: 'ds-library';
  };
  options: {
    draftAndPublish: true;
  };
